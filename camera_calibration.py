...
def calibrate_camera():
    ...
    if gray is None or len(objpoints) == 0:
...
def parse_args():
    ...
    parser.add_argument('--chessboard_rows', type=int, default=23, help='Number of inner corners per chessboard row')
    parser.add_argument('--chessboard_cols', type=int, default=15, help='Number of inner corners per chessboard column')
    parser.add_argument('--square_size', type=float, default=2.5, help='Size of each square on the chessboard (in cm)')
    parser.add_argument('--calibration_path', type=str, default='calibration_images/*.jpg', help='Path pattern to calibration images')
    parser.add_argument('--output_dir', type=str, default='output', help='Directory to save calibration results')
...
def main():
    ...
    global CHESSBOARD_SIZE, SQUARE_SIZE, CALIBRATION_IMAGES_PATH, OUTPUT_DIRECTORY, SAVE_UNDISTORTED
    CHESSBOARD_SIZE = (args.chessboard_rows, args.chessboard_cols)
    SQUARE_SIZE = args.square_size
    CALIBRATION_IMAGES_PATH = args.calibration_path
